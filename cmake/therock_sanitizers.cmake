...
function(therock_sanitizer_configure
  ...
  if(_sanitizer STREQUAL "ASAN" OR _sanitizer STREQUAL "HOST_ASAN")
    ...
    # Use _INIT variants so CMake appends to its defaults rather than replacing them.
    # This preserves -O2 from CMAKE_CXX_FLAGS_RELWITHDEBINFO defaults.
    string(APPEND _stanza "string(APPEND CMAKE_CXX_FLAGS_RELWITHDEBINFO_INIT \" -gdwarf-4\")\n")
    string(APPEND _stanza "string(APPEND CMAKE_C_FLAGS_RELWITHDEBINFO_INIT \" -gdwarf-4\")\n")
